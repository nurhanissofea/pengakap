...
<html lang="en">
    <head>
        ...
        <title>Login - Persekutuan Pengakap Malaysia</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="login.php" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="auth-password-basic.php">Forgot Password?</a>
                                                <button type="submit" name="submit" value="login" class="btn btn-primary">Login</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="auth-register-basic.php">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
